...
async function iqLoadFromAPI() {
    const url = new URL(IQ_CONFIG.WEB_APP_URL);
    ...
    try {
        localStorage.setItem(IQ_CONFIG.LOCAL_STORAGE_KEY, JSON.stringify(data.records || []));
    } catch (e) { /* ignore quota errors */ }
    return iqNormalizeRecords(data.records || []);
}
