...
(() => {
    ...
    //    Con ?v= para que el navegador tome la versión nueva en cada despliegue.
    if (!document.getElementById("iq-stylesheet")) {
        ...
        link.rel  = "stylesheet";
        link.href = "css/indicadores_calidad.css?v=" + version;
    ...
    root.innerHTML = `
        ...
        <div class="iq-filters">
            ...
            <div class="filter-group">
                ...
                <div class="cod-art-combo" id="cod-art-combo">
                    <button type="button" id="cod-art-trigger" class="filter-select cod-art-trigger"
                            aria-haspopup="dialog" aria-expanded="false"
                            title="Seleccionar uno o varios códigos de artículo">
                        <span class="cod-art-trigger-text" id="cod-art-trigger-text">Todos</span>
                        <span class="cod-art-caret" id="cod-art-caret">▾</span>
                    </button>
                    <button type="button" id="cod-art-clear" class="cod-art-clear hidden"
                            title="Quitar el filtro de códigos">×</button>
                    <div id="cod-art-dropdown" class="cod-art-dropdown hidden" role="dialog"
                         aria-label="Filtro de códigos de artículo">
                        <div class="cad-search-row">
                            <span class="cad-search-icon">🔍</span>
                            <input type="text" id="cod-art-search" class="cad-search"
                                   placeholder="Buscar código o artículo…"
                                   autocomplete="off" spellcheck="false">
                            <button type="button" id="cod-art-search-clear" class="cad-search-clear hidden"
                                    title="Borrar búsqueda">×</button>
                        </div>
                        <div class="cad-toolbar">
                            <label class="cad-selectall">
                                <input type="checkbox" id="cod-art-select-all">
                                <span id="cod-art-select-all-label">(Seleccionar todo)</span>
                            </label>
                            <span class="cad-count" id="cod-art-count"></span>
                        </div>
                        <div class="cad-list" id="cod-art-list" role="listbox" aria-multiselectable="true" tabindex="-1"></div>
                        <div class="cad-hint">
                            Shift + clic marca un rango · Pega una lista separada por comas para buscar varios códigos a la vez
                        </div>
                        <div class="cad-footer">
                            <button type="button" class="cad-btn cad-btn-link" id="cod-art-reset">Borrar filtro</button>
                            <div class="cad-footer-actions">
                                <button type="button" class="cad-btn" id="cod-art-cancel">Cancelar</button>
                                <button type="button" class="cad-btn cad-btn-primary" id="cod-art-apply">Aceptar</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="matriz-modal" class="modal-overlay hidden">
            <div class="modal-box matriz-modal-box">
                <div class="modal-header">
                    <div>
                        <h2 id="matriz-modal-title">Detalle de partidas</h2>
                        <p id="matriz-modal-sub"></p>
                    </div>
                    <button id="matriz-close" class="modal-close" title="Cerrar">✕</button>
                </div>
                <div class="table-scroll-container matriz-modal-scroll">
                    <table class="iq-table">
                        <thead>
                            <tr>
                                ...
                                <th>OP-PTDA</th>
                                <th>Cod. Art.</th>
                                <th class="th-left">Artículo</th>
                                <th class="th-left">Color</th>
                                <th>Kg</th>
                            </tr>
                        </thead>
                        <tbody id="matriz-detail-tbody"></tbody>
                    </table>
                </div>
            </div>
        </div>
