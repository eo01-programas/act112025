(() => {
    ...
    // Vistas "vanilla": JS clásico (sin JSX) compuesto por varios scripts que se
    // cargan en orden como <script> nativos (sin compilar con Babel). El primer
    // script monta el esqueleto HTML; el último arranca la app.
        ...
        .then(source => {
            try {
                const compiled = Babel.transform(source, {
                    // sourceType "script" + runtime "classic" evitan que Babel
                    // genere sentencias `import` (jsx-runtime automático), que
                    // rompen al inyectarse como <script> normal (no módulo).
                    sourceType: "script",
