...
// Generado: 2026-07-05T23:52:10.983Z con tools/compile_jsx.js
...
(function () {
  ...
  var buildChartData = function buildChartData(partidas, mode, fCliente) {
    ...
    conPeriodo.forEach(function (p) {
      ...
      var bolsa = p.estado === 'aprobada' ? 'aprobadas' : 'rechazadas';
  ...
  var ChartModal = function ChartModal(_ref5) {
    ...
    var _useState3 = useState(''),
      ...
      fCli = _useState4[0],
      setFCli = _useState4[1]; // '' = todos los clientes
    ...
    var chartData = useMemo(function () {
      return buildChartData(partidas, mode, fCli);
    }, [partidas, mode, fCli]);
    ...
    }, "El porcentaje sobre cada per\xEDodo es el ", /*#__PURE__*/React.createElement("b", null, "nivel de rechazo"), " (partidas rechazadas \xF7 partidas auditadas). Pase el cursor sobre las barras para ver el detalle por cliente."), /*#__PURE__*/React.createElement("div", {
      className: "relative",
      style: {
        height: '58vh',
        minHeight: '360px'
  ...
  function App() {
    ...
    var _useState11 = useState(''),
      ...
      fCliente = _useState12[0],
      setFCliente = _useState12[1];
    var _useState13 = useState(''),
      _useState14 = _slicedToArray(_useState13, 2),
      fTipoTela = _useState14[0],
      setFTipoTela = _useState14[1];
    // '' = todas (aprobadas y rechazadas); las "en evaluación" ya no se listan
    var _useState15 = useState(''),
      _useState16 = _slicedToArray(_useState15, 2),
      fEstado = _useState16[0],
      setFEstado = _useState16[1];
    var _useState17 = useState(''),
      _useState18 = _slicedToArray(_useState17, 2),
      fMotivo = _useState18[0],
      setFMotivo = _useState18[1];
    var _useState19 = useState(false),
      _useState20 = _slicedToArray(_useState19, 2),
      showChart = _useState20[0],
      setShowChart = _useState20[1];
