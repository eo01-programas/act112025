...
// Generado: 2026-07-03T13:04:53.250Z con tools/compile_jsx.js
...
(function () {
  ...
  function App() {
    ...
    var _useState13 = useState('evaluacion'),
      _useState14 = _slicedToArray(_useState13, 2),
      fEstado = _useState14[0],
      setFEstado = _useState14[1];
    var _useState15 = useState(false),
      _useState16 = _slicedToArray(_useState15, 2),
      showChart = _useState16[0],
      setShowChart = _useState16[1];
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            ...
            case 3:
              ...
              return res.text();
            case 4:
              data = _t.parse.call(_t, _context.v);
              if (data.success) {
                _context.n = 5;
                break;
              }
            ...
            case 6:
              _context.p = 6;
              _t2 = _context.v;
              console.error('[trazabilidad_op] Error cargando datos:', _t2);
    ...
    var clientes = useMemo(function () {
      return _toConsumableArray(new Set(records.map(function (r) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      value: ""
    }, "Estado"), /*#__PURE__*/React.createElement("option", {
      value: "aprobada"
    }, "Aprobadas"), /*#__PURE__*/React.createElement("option", {
      value: "rechazada"
    }, "Rechazadas"), /*#__PURE__*/React.createElement("option", {
      value: "evaluacion"
    }, "En evaluaci\xF3n")), /*#__PURE__*/React.createElement("div", {
    ...
    }, error)) : filtered.length === 0 ? /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("td", {
      colSpan: "8",
      className: "px-6 py-16 text-center text-[#667466]"
    }, "Sin coincidencias. Ajuste la b\xFAsqueda o los filtros.")) : filtered.map(function (r, i) {
