(() => {
    ...
    const { WEB_APP_URL, BASE_SHEET_HEADER_ROWS = 1 } = window.APP_CONFIG;
...
const { useState, useEffect, useMemo, useCallback, useRef } = React;
        ...
        // ============================================
        const APPS_SCRIPT_URL = WEB_APP_URL;
        // ============================================
        ...
        const DEFECT_CONFIG = {
            ...
            "2.10.2002 Falla De Lycra a lo Ancho": { valor: "MTS", codigo: "2.10.2" },
        ...
        // ============================================
        function HorizontalBarChart({ data, title = '%', emptyMessage = '', maxItems = 15, labelWidthClass = 'w-36' }) {
        ...
        function App() {
            ...
            const defectSummary = useMemo(() => {
                ...
                // Inicializar totales
                defectColumnsFromData.forEach(defect => totals[defect] = 0);
                ...
                const summary = defectColumnsFromData
                    .map(defect => {
                        ...
                        return {
                            ...
                            valor: meta.valor,
                            codigo: meta.codigo,
                            total: totals[defect] || 0,
                            percentage: grandTotal > 0 ? ((totals[defect] || 0) / grandTotal) * 100 : 0
                        };
                    })
            ...
            const machineBreakdown = useMemo(() => {
                ...
                return {
                    grupo: buildCategoryParticipationData(
                        ...
                        selectedDefectDetail.defecto,
                        (row) => {
                            const machineName = String(getRowValue(row, machineColumn, ['Máquina', 'Maquina', 'MÃ¡quina', 'Machine']) || '').trim();
                    ...
                    maquina: buildCategoryParticipationData(
                        rawData,
                        selectedDefectDetail.defecto,
                        (row) => String(getRowValue(row, machineColumn, ['Máquina', 'Maquina', 'MÃ¡quina', 'Machine']) || '').trim(),
