...
// ==========================================
        ...
        const App = () => {
            ...
            const [destKeys, setDestKeys] = React.useState([]); // NUEVO: Almacenará el orden exacto de las columnas de tu Google Sheet
            ...
            const handleSave = async () => {
                ...
                try {
                    ...
                    if (resultRollos.success) {
                        ...
                        setStatus('Reporte guardado, pero falló rollos: ' + (resultRollos.error || 'Desconocido'));
                        setIsUpdateMode(true);
                    }
                } catch (error) {
                    setStatus('Error de transmisión: ' + error.message);
                }
                setIsLoading(false);
            };
                ...
                <div>
                    <div className="no-print bg-white border-b border-gray-300 p-4 flex flex-wrap gap-4 items-end mb-4 shadow-sm max-w-[1200px] mx-auto">
                        ...
                        <div className="ml-auto flex items-center gap-3">
                            {isUpdateMode && <span className="text-xs font-bold text-blue-600 bg-blue-100 px-2 py-1 rounded">MODO ACTUALIZACIÓN</span>}
